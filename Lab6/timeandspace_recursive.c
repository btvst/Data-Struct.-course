...
void timeAndSpaceRecursiveSort(FILE *fptr,int NO_OF_RECORDS){
	...
	recursiveMergeSort(ls1,sz1, p1, &space);
	...
	if(NO_OF_RECORDS==1024){
		printf("----------------------------------------Recursive Sort Results----------------------------------------------------------\n");
	}
	printf("Recursive %d ; Space: %d\t; Time: %lf\n",NO_OF_RECORDS, space, elapsedtime);
	fprintf(fptr1,"Recursive %d : Space: %d\t; Time: %lf\n",NO_OF_RECORDS, space, elapsedtime);
